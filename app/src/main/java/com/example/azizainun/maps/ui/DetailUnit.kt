...
import com.example.azizainun.maps.Model.Model
import com.example.azizainun.maps.Model.Model_Detail
import com.example.azizainun.maps.ModelView.DetailUnitViewModel
...
//        var viewModel = DetailUnitViewModel()
//        val viewModel = ViewModelProviders.of(this).get(DetailUnitViewModel.class)
        val viewModel = ViewModelProviders.of(this).get(DetailUnitViewModel::class.java)

//        LiveData<DataSnapshot> liveData = viewModel.getDataSnapshotLiveData()

        viewModel?.dataSnapshotLiveData?.observe(this, Observer { snapshot ->
            val model_Detail:Model_Detail = snapshot?.getValue(Model_Detail::class.java)!!
            binding.detail = model_Detail
        })
